            ...
            <div class="col-lg-8 posts-list">
                    ...
                    <div class="d-sm-flex justify-content-between">
                        ...
                        <div class="buttonHeart">
                            ...
                            <span class="numb 1">{{ $countLike ?? '' }} </span>
                                @if (empty($countLike))
                                    <i class="user-like">be the first people like this review ^^</i>
                                @else
                ...
                <div class="blog-author">
                    <div class="media align-items-center flex">
                        ...
                        @else
                        <img class="avatar_reply" src="{{ asset('/assets/images/service/default-avatar.png') }}"
                            alt="" />
                        @endif
                ...
                <div class="comments-area">
                    ...
                    @include('comment_list', ['comments' => $review->comments->whereNull('comment_parent_id'),
                    'review_id' => $review->id])
                </div>
...
<script>
    ...
    //     if ({{ !empty($countLike) }}) {
    //     $("i.user-like").html("people like this");
    // } else {
    //     $("i.user-like").html("Be the first people like this review ^^");
    // }
    // });
</script>
<script>
